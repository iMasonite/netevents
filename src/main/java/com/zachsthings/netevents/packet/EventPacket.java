...
/** Represents an event that can be called across servers All events must implement both the
 * zero-args and argument-containing constructors */
public class EventPacket implements Packet {
  ...
  public static EventPacket read(ByteBuffer buf) throws IOException {
    ...
    if (!(o instanceof Event)) throw new IOException("Read object " + o + " is not an Event");
  ...
  public String toString() {
    return "EventPacket{" + "uid=" + uid + ", sendEvent=" + sendEvent + '}';
  }
}
